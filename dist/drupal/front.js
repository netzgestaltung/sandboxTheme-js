...
;(function($, D){
  ...
  sandboxTheme.features = {
    ...
    dummy: {
      ...
      ready: function ready(){
        ...
        document.body.classList.add(this.info.name + '-' + this.options.classNames.active);
  ...
  if ( typeof drupalSettings !== 'undefinded' ) {
    sandboxTheme.init(drupalSettings);
  }
})(jQuery, Drupal);
